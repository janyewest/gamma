...
def to_supabase_db(outfile: str, url: str, account: str, key: str, table: str, flat_data):
    ...
    key = get_key_from_keychain(key, account)
...
if __name__ == '__main__':
    ...
    supabase_url = YOUR_SUPABASE_URL  # str
    supabase_account = YOUR_SUPABASE_ACCOUNT  # str
    supabase_key = YOUR_SUPABASE_KEY  # str
    ...
    # display whole dataframe to console
